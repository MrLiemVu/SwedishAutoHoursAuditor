...
public class AutoHoursAuditor { // Version 1.4
   
   // *** FILL OUT PART ***
   
   public static String initials = "QHV"; // Your Initials
   public static String date = "12/9/2022"; // Today's Date
   ...
   public static void main(String[] args) throws IOException {
      ...
      String[] findScholarData = fileName.split(" ");
      boolean JHS = false;
      ...
      while (iterator.hasNext()) {
         ...
         while (cellIterator.hasNext() && rowCount > 1) {
            ...
            if (colCount == 7) {
               ...
               } else if (rotationType.contains("PACU")) {
      ...
      try {
         ...
         // Creates the folder to put the scholar excel files in
         String newDirectory = lastName + ", " + firstName + "/";
         File file = new File(outputDir + "/" + newDirectory);
         file.mkdir();
         
         // Output the Excel File
         FileOutputStream out = new FileOutputStream(new File(outputDir + "/" + newDirectory + newFileName));
         workbook.write(out);
         out.close();
         
         // Print out the summary of a run to console.
         ...
         if (problem == 0) {
            ...
            System.out.println("ERROR(S) DETECTED: " + fileName + " has been written, but " + problemString + " error(s) has been found.");
         }
         System.out.println();
         System.out.println("********************************************************************************************    ");
      }
...
//    public static String initials = "QLV";
//    public static String date = "3/17/2022";
//    
//    // Put Scholar Details here!
//    public static boolean JHS = false; // True or False
//    public static String lastName = "Vu";
//    public static String firstName = "Quoc-Liem";
//    public static String rotation = "2020A";
//    public static String fileName = "mrliem.xls";
