...
public class AutoHoursAuditor { // Version 1.3
   
   // *** FILL OUT PART ***
   
   public static String initials = "QLV"; // Your Initials
   public static String date = "8/23/2022"; // Today's Date
   public static String fileName = "Hesham Katabi 2021D JHS.xls"; // File Name to Audit
   ...
   public static void main(String[] args) throws IOException {
      ...
      try {
         String fileName = lastName + "_" + firstName + " " + JHSname + rotation + " Hours Summary.xlsx";
